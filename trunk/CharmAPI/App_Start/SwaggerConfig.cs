...
namespace CharmAPI
{
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "CharmAPI");
                        ...
                        c.IncludeXmlComments(System.AppDomain.CurrentDomain.BaseDirectory + "/bin/CharmAPI.XML");
                ...
                .EnableSwaggerUi(c =>
                    {
                        ...
                        c.InjectJavaScript(thisAssembly, "CharmAPI.Scripts.swagger.js");
    ...
    public class CachingSwaggerProvider : ISwaggerProvider
    {
        ...
        {
            string xmlpath = string.Format("{0}/bin/CharmAPI.XML", System.AppDomain.CurrentDomain.BaseDirectory);
